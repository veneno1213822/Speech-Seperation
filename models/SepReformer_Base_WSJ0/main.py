...
def main(args):
    ...
    if args.engine_mode == 'infer_sample':
        engine._inference_sample(args.sample_file, args.out_wav_dir)
    elif args.engine_mode == 'infer_sample_multi':
        engine._inference_sample_multi(args.sample_file, args.out_wav_dir)
    else:
        engine.run()